...
describe('Check-in Use Case', () => {
  beforeEach(async () => {
    ...
    sut = new CheckInUseCase(checkInsRepository, gymnsRepository)

    await gymnsRepository.create({
      id: 'gym-01',
  ...
  it('should not be able to check in on distant gym', async () => {
    await gymnsRepository.create({
      ...
      description: '',
      phone: '',
      latitude: new Decimal(-27.649089),
      longitude: new Decimal(-52.2621026)
    })
    ...
    await expect(() =>
      sut.execute({
        gymId: 'gym-02',
        userId: 'user-01',
        userLatitude: -27.6343469,
        userLongitude: -52.2684413
